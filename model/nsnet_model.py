...
class NSNetModel(pl.LightningModule):
    ...
    def __init__(self, hparams={'train_dir': Path(), 'val_dir': Path(), 'batch_size': 4, 'n_fft': 512,
                                            'n_gru_layers': 3, 'gru_dropout': 0, 'alpha': 0.35,
                                            'num_workers' : 24}):
        ...
        self.train_dir = Path(hparams['train_dir'])
        self.val_dir = Path(hparams['val_dir'])
        self.batch_size = hparams['batch_size']
        self.n_fft = hparams['n_fft']
        self.n_frequency_bins = self.n_fft // 2 + 1
        self.n_gru_layers = hparams['n_gru_layers']
        self.gru_dropout = hparams['gru_dropout']
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('train_loss', value=loss_val.item())
    ...
    #     self.log('train_loss_mean', value=val_loss_mean)
    #     return outputs
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.log('val_loss_mean', value=val_loss_mean)
